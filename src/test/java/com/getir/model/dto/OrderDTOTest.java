...
public class OrderDTOTest {
    ...
    public void it_should_convert_to_string_properly() {
        ...
        Assertions.assertEquals(orderStringValue,"OrderDTO{id=11, customerId=1, totalCost=15, dateCreated=Sun Jul 07 00:00:00 TRT 3895, bookList=[BookDTO(id=1, name=1984, author=George Orwell, cost=1.0, remainingStock=1)], totalBookCount=null}");
    }
}
